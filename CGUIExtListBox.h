...
namespace gui
{
	...
	class CGUIExtListBox : public IGUIListBox
	{
	public:
// --------------------------------------------------------
    virtual void setListTopItem(s32 index);
	virtual s32 addItem(const wchar_t* text, video::SColor color);
    virtual s32 addItem(const wchar_t* text, video::SColor color, const wchar_t* icon);
    virtual void setItemColor(s32 index, video::SColor color);
// --------------------------------------------------------

		//! constructor
		CGUIExtListBox(IGUIEnvironment* environment, IGUIElement* parent, 
